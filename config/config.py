...
EXTRA_PLUGINS = is_true(getenv("EXTRA_PLUGINS", "Ture"))
...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/vishalpandeynkp/professor-extra-pluging",
)
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/vishalpandeynkp/privete-nhi-h-bhai",
)
...
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/heroku_club"
)  # Example:- https://t.me/heroku_club
